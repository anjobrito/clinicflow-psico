...
type Status = "DEMO" | "TRIAL" | "ACTIVE" | "BLOCKED" | "CANCELED";
...
export default function AjbAdminPage() {
  ...
  function setStatus(status: Status) { setTenants((current) => current.map((tenant) => tenant.id === selected.id ? { ...tenant, status } : tenant)); }
